...
class PatientSupportInsights extends Component
{
    ...
    public function placeholder()
    {
        ...
        <div class="space-y-8 animate-pulse">
            <div class="p-8 bg-gray-100/50 dark:bg-gray-800/20 rounded-mega border border-gray-100 dark:border-gray-800 h-40">
            ...
            <div class="p-8 bg-gray-100/30 dark:bg-gray-800/10 rounded-mega border border-gray-100 dark:border-gray-800 h-32">
                 <div class="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded mb-4"></div>
