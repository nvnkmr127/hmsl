...
<span class="{{ $class }} flex-shrink-0">
    @switch($name)
        @case('home')
        ...
        @case('calendar')
            ...
            @break
        @case('bed')
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M3 12h18M3 6h18M3 18h18M5 6v12M19 6v12"/></svg>
            @break
        @case('monitor')
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            @break
        @case('credit-card')
        ...
        @case('flask')
            ...
            @break
        @case('pill')
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M18.422 13.586a5 5 0 00-7.072-7.072L3.586 14.28a5 5 0 007.072 7.072l7.764-7.766zM15 10l-4 4"/></svg>
            @break
        @case('box')
        ...
        @case('clipboard')
            ...
            @break
        @case('link')
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.828a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/></svg>
            @break
        @case('arrow-up')
        ...
        @case('key')
            ...
            @break
        @default
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M9 5l7 7-7 7"/></svg>
    @endswitch
</span>
