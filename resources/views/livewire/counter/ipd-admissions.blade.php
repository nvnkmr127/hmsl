<div>
                            ...
                            <tr class="group hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors">
                                ...
                                <td class="px-8 py-6 text-right">
                                    <div class="flex justify-end gap-2">
                                        <button wire:click="$dispatch('edit-admission', { id: {{ $adm->id }} })" class="p-3 bg-indigo-50 dark:bg-indigo-950/30 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition-all shadow-sm hover:shadow-lg hover:shadow-indigo-500/20" title="Edit Admission">
    ...
    <livewire:counter.ipd-admission-edit />
</div>
