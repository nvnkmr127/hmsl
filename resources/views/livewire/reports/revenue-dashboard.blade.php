<div class="space-y-8">
    <!-- Filter Header -->
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-gray-800 p-6 rounded-mega border border-gray-100 dark:border-gray-700/50 shadow-sm">
        <div>
            <h2 class="text-xl font-black text-gray-800 dark:text-white uppercase tracking-tight">Revenue Stats</h2>
            <p class="text-tiny font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest mt-1">Financial performance across departments</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-indigo-600 p-8 rounded-mega text-white shadow-xl shadow-indigo-500/20 relative overflow-hidden group">
            ...
            <p class="text-tiny font-black uppercase tracking-[0.2em] text-indigo-200 mb-2">Total Collection</p>
            <h3 class="text-3xl font-black italic">₹{{ number_format($totalRevenue, 2) }}</h3>
            <p class="text-tiny font-bold mt-4 text-indigo-100">{{ $totalBills }} SETTLED INVOICES</p>
        </div>

        <div class="bg-white dark:bg-gray-800 p-8 rounded-mega border border-gray-100 dark:border-gray-700/50 shadow-sm relative overflow-hidden group">
            <p class="text-tiny font-black uppercase tracking-[0.2em] text-gray-400 mb-2">Net Discount</p>
        ...
        <div class="bg-white dark:bg-gray-800 p-8 rounded-mega border border-gray-100 dark:border-gray-700/50 shadow-sm relative overflow-hidden group">
            <p class="text-tiny font-black uppercase tracking-[0.2em] text-gray-400 mb-2">Tax Collected</p>
            <h3 class="text-3xl font-black text-emerald-500 italic">₹{{ number_format($totalTax, 2) }}</h3>
            <p class="text-tiny font-bold mt-4 text-gray-400 uppercase tracking-widest">Calculated GST/VAT</p>
        </div>

        <div class="bg-white dark:bg-gray-800 p-8 rounded-mega border border-gray-100 dark:border-gray-700/50 shadow-sm relative overflow-hidden group">
            <p class="text-tiny font-black uppercase tracking-[0.2em] text-gray-400 mb-2">Avg. Ticket Size</p>
            ...
            <p class="text-tiny font-bold mt-4 text-gray-400 uppercase tracking-widest">per patient visit</p>
        </div>
    </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    @forelse($paymentMethodSplit as $method)
                        <div class="p-4 bg-gray-50 dark:bg-gray-900/40 rounded-3xl border border-gray-100 dark:border-gray-700/50">
                            <p class="text-tiny font-black text-gray-400 uppercase tracking-widest mb-1">{{ $method['payment_method'] ?: 'Other' }}</p>
                            ...
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors">
                                ...
                                <td class="px-6 py-4 lowercase first-letter:uppercase">
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-tiny text-gray-400 font-bold tracking-widest">{{ $bill->patient->uhid }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <span class="text-tiny text-gray-400 font-bold uppercase">{{ $bill->created_at->diffForHumans() }}</span>
                                </td>
                            </tr>
                        @empty
