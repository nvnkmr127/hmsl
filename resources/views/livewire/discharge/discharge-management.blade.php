    ...
    <x-modal name="pending-bill-modal" title="Pending Bill Settlement">
        <div class="p-6">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-amber-700 dark:text-amber-300 mt-1">
                            The patient has an unsettled final bill. 
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <a href="{{ route('billing.index', ['collect_bill' => $selectedAdmissionId ? \App\Models\Admission::find($selectedAdmissionId)?->finalBill?->id : null]) }}" class="btn btn-primary">Collect Payment</a>
            </div>
        </div>
    </x-modal>
</div>
