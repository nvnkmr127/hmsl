<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div class="glass-card p-6 bg-gradient-to-br from-indigo-500/10 to-transparent border border-indigo-100 dark:border-indigo-900/30">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-[10px] font-black text-indigo-500 uppercase tracking-widest px-2 py-1 bg-indigo-50 dark:bg-indigo-950/30 rounded-lg">Lifetime</span>
        </div>
    ...
    <div class="glass-card p-6 bg-gradient-to-br from-emerald-500/10 to-transparent border border-emerald-100 dark:border-emerald-900/30">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-[10px] font-black text-emerald-500 uppercase tracking-widest px-2 py-1 bg-emerald-50 dark:bg-emerald-950/30 rounded-lg">{{ now()->format('F') }}</span>
        </div>
    ...
    <div class="glass-card p-6 bg-gradient-to-br from-amber-500/10 to-transparent border border-amber-100 dark:border-amber-900/30">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-[10px] font-black text-amber-500 uppercase tracking-widest px-2 py-1 bg-amber-50 dark:bg-amber-950/30 rounded-lg">Today</span>
        </div>
    ...
    <div class="glass-card p-6 bg-gradient-to-br from-violet-500/10 to-transparent border border-violet-100 dark:border-violet-900/30">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-[10px] font-black text-violet-500 uppercase tracking-widest px-2 py-1 bg-violet-50 dark:bg-violet-950/30 rounded-lg">Today</span>
        </div>
