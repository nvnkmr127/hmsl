...
@section('title', 'OP Bill — ' . $bill->bill_number)
...
<div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 15px;">
    <h2 style="margin: 0; font-size: 14pt; font-weight: 900; text-decoration: underline; color: #000;">OP BILL</h2>
...
<table class="items-table">
    ...
    <tbody>
        @php
            $groupNames = ['Consultation' => 'CONSULTATION', 'Lab' => 'INVESTIGATIONS', 'Service' => 'SERVICES', 'Medicine' => 'PHARMACY'];
